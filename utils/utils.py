...
def hyperparameter_grid_search(hparams, data, exp, args, search_metric, evaluator, exp_arg=None):
...
def write_res_to_file(file, dataset, metric, test_mean, val_mean=0, test_std=0,  val_std=0, params=None, res=None):
